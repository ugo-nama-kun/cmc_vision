...
class MetersGroup(object):
    def __init__(self, csv_fle_name, formatting):
        self._csv_file_name = csv_fle_name
...
class Logger(object):
    def __init__(self, log_dir: Path, use_tb):
        self._log_dir = log_dir

        self._train_mg = MetersGroup(log_dir / "train.csv",
                                     formatting=COMMON_TRAIN_FORMAT)
    ...
    def log(self, key, value, step):
        ...
        assert key.startwith("train") or key.startwith("eval")
        ...
        mg = self._train_mg if key.startwith("train") else self._eval_mg
        mg.log(key, value)
